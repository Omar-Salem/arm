...
ros2 topic pub --once /arm_controller/joint_trajectory trajectory_msgs/msg/JointTrajectory '{joint_names:["waist_joint","shoulder_joint","biceptricep_joint","forearm_joint"],points: [{positions:[2,4,6,9]}]}'
